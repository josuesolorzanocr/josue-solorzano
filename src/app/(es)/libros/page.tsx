      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            bookSchema({ title: book.title, description: book.description, year: book.year, publishedAt: book.publishedAt, isbn: book.isbn, publisher: book.publisher, slug: book.slug })
          ),
        }}
      />
      <script
